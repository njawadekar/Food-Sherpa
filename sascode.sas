...
libname a 'P:\public_users\njawadekar\Work';
  
  
/* Importing the csv */
data a.fidata;
  
  infile 'P:\public_users\njawadekar\Work\FI.csv'  dlm=',' dsd missover firstobs=2;
...
proc export data = a.Fidata7
     outfile = 'P:\public_users\njawadekar\Work\Violations.txt'
	 dbms = tab;
	 run;


	 proc export data = a.Grades1
	 outfile = 'P:\public_users\njawadekar\Work\Grades.txt'
	 dbms = tab;
	 run;
